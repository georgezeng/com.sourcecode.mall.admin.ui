  ...
  <div>
    ...
    <Card style="margin-top: 20px;">
      ...
      <Table :columns="columns"
             :data="[{...data.subOrder, nums: data.nums, totalPrice: (data.nums * data.subOrder.unitPrice).toFixed(2), dealPrice: data.amount}]"></Table>
    </Card>
    ...
    <Card style="margin-top: 20px; margin-bottom: 20px;">
      ...
      <div
        v-if="data.status.name != 'Processing'
        && data.status.name != 'WaitForReturn'
        && data.status.name != 'WaitForReceive'
        && data.status.name != 'WaitForSend'
        ...
        <div>
          <div style="display: inline-block; width: 30%;">
            <span style="margin-right: 10px;">物流公司:</span>
            {{data.merchantExpressCompany}}
          </div>
          <div style="display: inline-block; width: 30%;">
            <span style="margin-right: 10px;">物流单号:</span>
            {{data.merchantExpressNumber}}
          </div>
          <div v-if="data.status.name == 'WaitForPickup'" style="display: inline-block; width: 30%;">
            <span style="margin-right: 10px;">状态:</span>
            待收货
          </div>
          <div v-else style="display: inline-block; width: 30%;">
