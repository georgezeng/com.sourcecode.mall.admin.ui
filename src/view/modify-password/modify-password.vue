<template>
  <div>
    <Modal :value="show" title="修改密码" @on-cancel="triggerModal">
      <Form ref="form" :model="form" :rules="rules" :label-width="80" :class="{hidden: showForget}">
      ...
      <ForgetPassword :mobile="mobile" :hideBtns="true" :class="{hidden: !showForget}"/>
      <div slot="footer" :class="{hidden: showForget}">
